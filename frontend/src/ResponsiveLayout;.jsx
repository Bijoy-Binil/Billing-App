  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-100">
      ...
      <div className="flex-1 flex flex-col">
        {/* ✅ Top Navbar */}
        <header className="sticky top-0 z-30 bg-gray-900/70 backdrop-blur-xl border-b border-gray-800 px-4 py-3 flex items-center justify-between md:hidden">
          <button
            onClick={() => setSidebarOpen(true)}
            className="p-2 rounded-md text-gray-300 hover:text-emerald-400 hover:bg-gray-800 transition"
          >
            <Menu size={24} />
          </button>
