        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-600 text-white rounded-xl shadow flex items-center gap-2 text-xs sm:text-sm disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={data.length === 0}
              className="px-4 sm:px-6 py-2.5 sm:py-3 bg-indigo-600 text-white rounded-xl shadow flex items-center gap-2 text-xs sm:text-sm disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="px-4 sm:px-6 py-2.5 sm:py-3 bg-gray-100 text-gray-700 rounded-xl border shadow flex items-center gap-2 text-xs sm:text-sm"
            >
              {loading ? (
                <SectionLoader small />
              ) : (
              ...
              <table className="w-full text-xs sm:text-sm">
                <thead className="bg-gradient-to-r from-blue-50 to-indigo-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-center font-bold text-xs">Margin %</th>
                    <th className="px-4 py-3 text-center font-bold text-xs">Category</th>
                  </tr>
                </thead>
                ...
                <tbody className="divide-y divide-blue-100">
                  {data.map((r, i) => (
                    <tr key={i} className="hover:bg-blue-50 transition">
                      ...
                      <td
                        className={`px-4 py-3 text-center font-bold ${color(
                          r.margin_percent
                        )} text-sm`}
                      >
                        {r.margin_percent}%
                      ...
                      <td className="px-4 py-3 text-center">
                        <span
                          className={`px-3 py-1.5 rounded-full text-white text-xs font-semibold ${badge(
                            r.margin_percent
                          )}`}
                        >
