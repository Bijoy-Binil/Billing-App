...
const Dashboard = () => {
  ...
  // ⬅️ GLOBAL LOADER (using your SectionLoader)
  if (loading) {
    return (
      <div className="w-full min-h-screen flex items-center justify-center bg-[#E7F0FF]">
        <SectionLoader />
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="bg-[#c6d8f1] rounded-2xl shadow-sm border border-gray-200 p-5">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-800">Today's Bills</h2>
