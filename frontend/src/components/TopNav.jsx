...
const TopNav = ({ onMenu }) => {
  ...
  return (
    <header className="flex items-center justify-between px-6 md:px-20 py-5.5 border-b border-gray-700 bg-linear-to-r from-gray-900/95 via-gray-800/80 to-gray-900/95 backdrop-blur-xl shadow-[0_0_10px_rgba(16,185,129,0.1)] transition-all duration-300">
      {/* Left Section */}
        ...
        {userName ? (
          <>
            ...
            <div className="relative group">
              <div className="w-10 h-10 rounded-full bg-linear-to-br from-emerald-500/30 to-cyan-500/30 flex items-center justify-center text-white font-bold text-lg shadow-[0_0_15px_rgba(16,185,129,0.3)] group-hover:scale-105 transition-transform duration-300">
